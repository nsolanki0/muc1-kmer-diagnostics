...
RES_DIR = "/scratch/solankin/MUC1/results/reRun2/10_5sim2Dipc100Hapc200Unmerged_FullBin_FULL_OOF_ZScoreC_31"
...
print("Raw Training data (FULL) shape:", X_train.shape)
print("Raw Validation data (FULL) shape:", X_val.shape)
...
print("Raw Training data (FULL) shape after alignment:", X_train.shape)
print("Raw Validation data (FULL) shape after alignment:", X_val.shape)
