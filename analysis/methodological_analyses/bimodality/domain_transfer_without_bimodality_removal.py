...
#RES_DIR = "/scratch/solankin/MUC1/results/reRun1/13_1sim2Dipc100Hapc200Unmerged_FullBin_RLKMC_Bimod_ZScoreC_31_260421" 
#PROJECT = "/Users/sol/_courses/project_work/thesis"

RES_DIR = "/Users/sol/_courses/project_work/thesis/results/reRun2/4figures/13_3sim2Dipc100Hapc200Unmerged_FullBin_RLKMC_WoBimod_31"
...
# RES_DIR = "/scratch/solankin/MUC1/results/reRun2/13_3sim2Dipc100Hapc200Unmerged_FullBin_RLKMC_WoBimod_YeoJC_31"
# RES_DIR = "/scratch/solankin/MUC1/results/reRun2/13_1sim2Dipc100Hapc200Unmerged_FullBin_RLKMC_WoBimod_ZScoreC_31"
# os.makedirs(RES_DIR, exist_ok=True)
...
for feat in sample_features:
    ...
    plt.legend()
    plt.savefig(os.path.join(RES_DIR, f"s1_{feat}_Dist_after.png"), dpi=300) 
    plt.show()  
    plt.close()
...
for feat in sample_features:
    ...
    plt.title(f"{feat}_(after)")
    plt.legend()
    plt.savefig(os.path.join(RES_DIR, f"s1_{feat}_after.png"), dpi=300)
    plt.show()
    plt.close()
