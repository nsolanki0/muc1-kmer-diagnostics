...
# =============================================
# Script: create_diploid_samples_neg
# Purpose: Create diploid samples from haplotypes (.fq)
# Author: NS
# =============================================

#SBATCH --job-name=createDiploid
#SBATCH --output=/create_diploidN_%A_%a.out
#SBATCH --error=/create_diploidN_%A_%a.err
#SBATCH --time=00:05:00
#SBATCH --mem=4G
#SBATCH --cpus-per-task=1
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --array=1-6790  # Adjust based on total pairs
...
GROUP1_LIST="../44dipNegMatSharked_R1list.txt"
GROUP2_LIST="../44dipNegPatSharked_R1list.txt"
OUTDIR="../diploidNegSharked"
